...
class About extends Component {
    ...
    <div className='description'>
        <p>Каждый день мир предлагает тебе огромное количество возможностей, но недостаток времени и непредвиденные обстоятельства не позволяют реализовать свой потенциал на 100%. Что дает тебе E-ON ENERGY DRINK? Силы и энергию, чтобы превратить каждую возможность в твою личную победу! Одерживая больше побед, ты окажешься впереди всех! Всегда впереди! Всегда на E-ON впереди!</p>
        <p>E-ON ENERGY DRINK — энергетический напиток с яркими вкусами и эффективной тонизирующей формулой на основе натуральных фруктовых соков. E-ON ENERGY DRINK не содержит искусственных красителей и консервантов.</p>
    </div>
        ...
        <div className='taste taste1'>
            ...
            <div className='taste taste2'>
                <div className='taste_description'>
                    ...
                    <div className='text'>
                    Взрывное сочетание сладкого граната, кислой клюквы 
и пряного имбиря — заряжает отличным настроением
и стимулирует внутренние силы. GINGER CRUSH создан для тех, кто чувствует пульс жизни, замечая все детали.
                    </div>
                </div>
                <div className='bottle_image'>
                ...
                <div className='taste_description'>
                    ...
                    <div className='text'>
  Оригинальный бодрящий вкус энергетического напитка, содержащий в себе всеми любимые классические фруктово- карамельные ноты гуараны. Заряжает энергией для активной жизни и обостряет чувство настоящего момента.
                    </div>
                </div>
                <div className='bottle_image'>
           ...
           <div className='taste taste4'>
                <div className='taste_description'>
                    ...
                    <div className='text'>
Классический насыщенный вкус апельсина — приятно бодрит
и тонизирует волю
