    ...
    render() {
        ...
        return (
            <div className='Questions'>
                <div className={`battery_btn btn${currentQuestion + 1}`} />
                ...
                <div className='answers'>
                    {questions[currentQuestion].answers.map(
                        (item, index) => {
                            return (
                                <div
                                    className={`answer overanswer question${currentQuestion +
                                        1}`}
                                    key={index}
                                    data-id={index}
                ...
                <div className={`panels_num_quesion q${currentQuestion + 1}`}>
                    {[...Array(3)].map((n, i) => {
                        return (
                            <div className='panels_num_quesion__item' key={i}>
                                <span className='num_answer'>
                                    вопрос {i+1}
                                </span>
                            </div>
                        );
